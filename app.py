...
# -----------------------------------------------------------------------------
st.set_page_config(
    page_title="Tablero de Monitoreo - Consorcio Integras",
    layout="wide",
...
# -----------------------------------------------------------------------------
# 2. ENCABEZADO CON TITULO ACTUALIZADO Y LOGO OPTIMIZADO
# -----------------------------------------------------------------------------
col_tit, col_logo = st.columns([3, 1])

with col_tit:
    st.title("Tablero de Monitoreo - Consorcio Integras")
    st.caption("Socio Prime / Líder: COOPI | Colíder: HIAS | Socios Implementadores: FLM, PLAFAM, PALUZ")
